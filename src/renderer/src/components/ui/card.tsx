  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        data-slot="card"
        className={cn(
          'bg-card text-card-foreground flex flex-col gap-1 rounded-md border-[0.5px] py-3 shadow-sm',
          className
        )}
        {...props}
      />
...
const CardTitle = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(
  ({ className, ...props }, ref) => {
    return (
      <div ref={ref} data-slot="card-title" className={cn('leading-none', className)} {...props} />
    )
  }
)
...
const CardContent = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(
  ({ className, ...props }, ref) => {
    return <div ref={ref} data-slot="card-content" className={cn('px-3', className)} {...props} />
  }
)
